...
document.addEventListener("DOMContentLoaded", () => {
  // データ 
  const BOOKS = [
    { title: "C++", tags: ["C++", "programming", "introduction book"], url: "book_A.html" },
    { title: "C言語入門", tags: ["C", "programming","introduction book"], url: "book_B.html" },
    { title: "プロになるJava", tags: ["Java", "programming","introduction book"], url: "book_C.html" },
    { title: "世界をアップデートする方法", tags: ["Philosophy", "humanity", "introduction book"], url: "book_D.html" },
    { title: "哲学のはじまり", tags: ["Philosophy", "humanity", "introduction book"], url: "book_E.html" },
    { title: "マスカレード・ナイト", tags: ["Mystery novel", "Suspense", "Keigo Higashino"], url: "book_F.html" },
    { title: "マスカレード・ホテル", tags: ["Mystery novel", "Suspense", "Keigo Higashino"], url: "book_G.html" },
    { title: "水田の小言を熟読するほど 一生ものの自炊力が身につく", tags: ["cooking", "recipe book", "Shinji Mizuta"], url: "book_H.html" },
    { title: "一汁三菜", tags: ["cooking", "recipe book", "Japanese food"], url: "book_I.html" },
    { title: "大戸屋", tags: ["cooking", "recipe book", "ootoya"], url: "book_J.html" },            
  ];
